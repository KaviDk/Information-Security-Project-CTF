          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        <a href="login.php" class="p-3 text-decoration-none text-light bold">Home</a>
                    ...
                    <div class="row justify-content-center  hackerFont ">
                        <div class="col-md-10">
                            ...
                            <ul>
                                ...
                                <li>Each question has some points to it depending upon the difficulty</li>
                                ...
                                <li>Flags found are of the format <span class="vim-caret">blacklist_ctf{some_text}.</span> Some of the files may contain just the inner text within the brackets. Make sure you submit it in the format specified. Flag text is not
                                    case sensitive.</li>
                            ...
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                    <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='./levels/level0.php'})();">
