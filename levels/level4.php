...
<div class="overlay"></div>
                ...
                <div class="hint-banner">
                    ...
                    <div id="instruction">
                        <p><b>Highly classified information was trasfered via an insecure channel.</b> Download and analyse the capture file </p>
                        <center><a style="font-size:1.2em; background-color:lightgoldenrodyellow; padding: 6px; border:2px solid red; border-radius: 5px;" 
                            href="../assets/flags/gambit.pcap" download="gambit">Download</a></center>
                    </div>
                </div>
