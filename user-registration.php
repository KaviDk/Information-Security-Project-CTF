...
<body class="imgloaded">
          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="user-registration.php" class="p-3 text-decoration-none text-white bold">Register</a>
                    </div>
                </div>
            </nav>
    ...
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div class="container">
            <div class="row">
                <div class="col-xl-10">
                    <h1 class="display-1 bold color_white content__title">BLACKLIST CTF<span class="vim-caret">&nbsp;</span></h1>
		...
		?>
				<div class="error-msg" id="error-msg"></div>
					...
					<div class="row">
					<div class="col-xl-12">
						<input class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" type="submit" name="signup-btn"
